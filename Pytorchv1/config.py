...
parser.add_argument('--dataset_path', default="./RibFrac/fixed_train",
                    help='fixed train set root path')
parser.add_argument('--val_data_path', default='./RibFrac/fixed_val',
                    help='fixed val set root path')
parser.add_argument('--test_data_path', default='./RibFrac/fixed_test', help='Testset path')
parser.add_argument("--train_gt_csv", default='./RibFrac/ribfrac-train-info.csv')
parser.add_argument("--val_gt_csv", default='./RibFrac/ribfrac-val-info.csv')
parser.add_argument('--save', default='UNet', help='save path of trained model')
parser.add_argument('--batch_size', type=list, default=9, help='batch size of trainset')
