...
if __name__ == '__main__':
    raw_dataset_path = '/Volumes/Seagate OneTouch SSD/ribfrac/train'
    fixed_dataset_path = './RibFrac/fixed_train'
    ...
    raw_dataset_path = '/Volumes/Seagate OneTouch SSD/ribfrac/val'
    fixed_dataset_path = "./RibFrac/fixed_val"
    ...
    raw_dataset_path = '/Volumes/Seagate OneTouch SSD/ribfrac/test'
    fixed_dataset_path = "./RibFrac/fixed_test"
