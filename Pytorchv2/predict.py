...
if __name__ == "__main__":
    ...
    parser.add_argument("--image_dir",default="/Volumes/Seagate OneTouch SSD/ribfrac/test/ct",
        help="The image nii directory.")
    parser.add_argument("--pred_dir",default="/Volumes/Seagate OneTouch SSD/ribfrac/test/label",
